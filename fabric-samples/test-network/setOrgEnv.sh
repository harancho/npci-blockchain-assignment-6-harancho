...
PEER0_ORG1_CA=${DIR}/test-network/organizations/peerOrganizations/JIO.example.com/tlsca/tlsca.JIO.example.com-cert.pem
PEER0_ORG2_CA=${DIR}/test-network/organizations/peerOrganizations/Airtel.example.com/tlsca/tlsca.Airtel.example.com-cert.pem
